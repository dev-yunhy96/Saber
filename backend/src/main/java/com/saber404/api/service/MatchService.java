...
//            JSONObject jsonObj1 = (JSONObject) obj1;
//            Match match = new Match();
//            match.setMatchId(jsonObj1.get("matchId").toString());
//            match.setMatchType(jsonObj1.get("matchType").toString());
//            match.setStartTime(jsonObj1.get("startTime").toString());
//            match.setEndTime(jsonObj1.get("endTime").toString());
//            match.setTrackId(jsonObj1.get("trackId").toString());
//            JSONArray jsonAry1 = (JSONArray) jsonObj1.get("players");
//            match.setPlayerCount(Long.valueOf(jsonAry1.size()));
//            for(int i=0; i<jsonAry1.size(); i++) {
//                JSONObject jsonObj2 = (JSONObject) jsonAry1.get(i);
//                MatchPlayer matchPlayer = new MatchPlayer();
//                matchPlayer.setMatch(match);
//                matchPlayer.setPlayer(player);
...
//                matchPlayer.setPlayer(player);
//                matchPlayer.setCharacterType(jsonObj4.get("character").toString());
//                matchPlayer.setMatchRank(jsonObj4.get("endTime").toString());
//                JSONObject jsonObj5 = (JSONObject) jsonObj4.get("player");
//                matchPlayer.setMatchRank(jsonObj5.get("matchRank").toString());
//                matchPlayer.setMatchRetired(jsonObj5.get("matchRetired").toString());
//                matchPlayer.setMatchWin(jsonObj5.get("matchWin").toString());
